  ...
  return (
    <div>
      ...
      <div className="bg-white p-3 rounded-xl border border-gray-200 mt-4 overflow-x-auto">
        ...
        {/* product table */}
        <ProductTable open={open} setOpen={setOpen} setProducts={setProducts} setEditProduct={setEditProduct} editProduct={editProduct} filteredProducts={filteredProducts} gridView={gridView} />
      </div>
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl after:absolute after:inset-y-0 after:left-0 after:w-px after:bg-white/10">
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      <AddProduct fetchProducts={fetchProducts} open={open} setOpen={setOpen} setEditProduct={setEditProduct} editProduct={editProduct} />
                    </div>
                  </div>
                </DialogPanel>
              </div>
