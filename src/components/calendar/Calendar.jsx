        ...
        <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              ...
              <input
                ...
                className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
              />
            </div>
          ...
          <div className="flex items-center gap-3 mt-6 sm:justify-end">
            <button
              onClick={closeModal}
              type="button"
              className="flex w-full sm:w-auto justify-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
            >
              Close
            </button>
            <button
