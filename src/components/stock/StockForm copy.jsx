...
export function StockEntryForm({ vendors, products, warehouses, onSubmit }) {
  ...
  const availableProducts = products.filter((p) => selectedVendor?.selectedProductIds?.includes(p._id))
